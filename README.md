...
📂 Project Structure
src/ ├── components/ # UI components (Navbar, MemberDescription, FineReport, etc.) ├── slices/ # Redux slices (members, books, loans, fines) ├── pages/ # Pages (Dashboard, Reports, etc.) ├── App.js # Main app with routes └── index.js # Entry point
